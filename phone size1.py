        ...
        MDBoxLayout:
            ...
            MDBoxLayout:
                ...
                MDRaisedButton:
                    ...
                    outline_color:'#000000'
                    font_size:'18dp'
                    pos_hint: {'center_x':.87,'center_y':0.1}
                    #on_release:app.stop()
                    on_release:app.ext()                   
    MDNavigationLayout:
        ScreenManager:
...
<Main>:
    ...
    MDLabel:
       ...
       # underline:True
        bold:True
        pos_hint:{'center_x':0.9,'center_y':.03}
    MDLabel:
        #text:'Change'
        text:
            """ 
...
<Student>:
    ...
    FloatLayout:
		...
		MDFloatLayout:
            ...
            canvas.before:
                Color:
                    rgba:get_color_from_hex('#ff061f')
                RoundedRectangle:
                    size:self.size
                    pos:self.pos
                    radius:[0,]
        ...
        ScreenManager:
            Screen:
                BoxLayout:
                    orientation: 'vertical'
                    MDToolbar:
                        title: "Save 'UG'Marks or 'PG'Marks"
                        elevation: 15
                        left_action_items: [['menu', lambda x: nav_drawer.set_state("open")]]
                        md_bg_color:app.theme_cls.accent_color
...
<It>:
	...
	MDIconButton:
        ...
        theme_text_color: "Custom"
        text_color: "#FFFF00"
        pos_hint: {'center_x':0.9,'center_y':.05}
        user_font_size : '20sp'
        on_press:
            root.manager.current = 'student'
            root.manager.transition.direction = 'right'
...
<Todo>:
    ...
    FloatLayout:
        ...
        MDLabel:
            ...
            bold:True
            underline:True
            pos_hint: {'center_x':.76,'center_y':.83}
            font_size:'29sp'
        MDLabel:
            id:date
            text:""
        ...
        MDFloatLayout:
            ...
            TextInput:
                id:task
                hint_text:'Enter MY TASK and Reminder '
                size_hint:1,None
        ...
        MDLabel:
	        ...
	        text: 
	            """*Please Enter date and week and Your Task!,\n
	        ...
	        color:'#FF4500'
	        bold:True
	        pos_hint: {'center_x':.6,'center_y':.10}
...
class MY_marks(MDApp):######  main class   ######
    ...
    def username_changer00(self):
        ...
        self.strng.get_screen('mainscreen').ids.profile_name00.text = f"\nHi, <'{self.store.get('UserInfo00')['name00']}'>Your name is cute..\n\n Using our app anytime..."
...
####################home screan code#####################
    def ext(self):
        self.task1 = MDDialog(title='Are you sure?',type="confirmation",text=f"Are you sure you want to exit My marks app?",
...
#################################general use code###################################
    ...
    def show_example_custom_bottom_sheet(self):
        sound=SoundLoader.load('waite.wav')
        if sound:
            sound.play()
...
###################################mark store and biodata############################################
    ...
    def check(self):
        ...
        if username_check_falsed or self.username_textd.split() == []:
            ...
            self.dialog1 = MDDialog(title='Not Enter Exam Number!', text="Please Enter Your Exam Number Type is (NO. xxxxxx)", size_hint=(0.7, 0.2),
        ...
        if username_check_falsec or self.username_textc.split() == []:
            ...
            self.dialog2 = MDDialog(title='Not Enter Studying UG!(or)PG! ', text="Please Enter Your Studying  ", size_hint=(0.7, 0.2),
        ...
        if username_check_falseb or self.username_textb.split() == []:
            ...
            self.dialog3 = MDDialog(title='Not Enter Which year? to Which year? ', text="Please Enter Your Duration of studey! ", size_hint=(0.7, 0.2),
        ...
        if username_check_falsea or self.username_texta.split() == []:
            ...
            self.dialog4 = MDDialog(title='Not Enter Department & section!', text="Please Enter Your Department & section", size_hint=(0.7, 0.2),
        ...
        if username_check_false1 or self.username_tex.split() == []:
            ...
            self.dialog5 = MDDialog(title='Not Enter Your college Name!', text="Please Enter Your College Name", size_hint=(0.7, 0.2),
        ...
        if username_check_false or self.username_text.split() == []:
            ...
            self.dialog6 = MDDialog(title='Not Enter Name!', text="Please Enter Your Name", size_hint=(0.7, 0.2),
    ...
    def on_start(self):
        ...
        self.strng.get_screen('ug').date.text=f"{day} {month} "
...
######################################YOUTUBE VIDEO DOWNLOADER CODE#################################
    ...
    def video_down(self, url):
        ...
        if url_check_false or self.text.split() == []:
        #if self.text.startswith==(""):
            check = MDRaisedButton(text='Retry!', on_release=self.check01)
            self.check1 = MDDialog(title='Paste Youtub url?', text="Please enter YouTube Video url!",md_bg_color= get_color_from_hex('#FF3D00'), size_hint=(0.7, 0.2),
                                   buttons=[check])
            self.check1.open()
        else:
            ...
            file_path = "/storage/emulated/0/YouTube_downloader/Videos"
    ...
    def audio_down(self, url):
        ...
        if url_check_false or self.text.split() == []:
            ...
            file_path1 = "/storage/emulated/0/YouTube_downloader/Audios"
            ...
            self.downloading_message = MDDialog(title="YouTube Audio Download Completed...!",type="confirmation",md_bg_color= get_color_from_hex('#00FF00'),
                                            text=f"Successfully Downloaded!- [{yt.title}] \n\nAudio Location ={file_path1}",size_hint=(0.8, 0.3),radius=[20, 7, 20, 7],
                                            buttons=[close_btn])
            self.downloading_message.open()
